...
if st.button("Predict", type='primary'):
    response = requests.post("https://pulususivatejareddy123-api-uii.hf.space/v1/customer", json=customer_data)    # enter user name and space name before running the cell
